...
const Hero = () => {
  return (
    <div className=" h-[90vh] flex justify-center items-center box-border px-4">
      <div className="w-[90%] max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 ">
        {/* Text Section */}
        <div className="text-[#0063A4] text-center md:text-left">
